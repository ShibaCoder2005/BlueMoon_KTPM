...
public class PhieuThu {
    ...
    /** tenNguoiLap: tham chiếu từ maTaiKhoan */
    ...
    public String getTenNguoiLap() { return tenNguoiLap; }
    public void setTenNguoiLap(String tenNguoiLap) { this.tenNguoiLap = tenNguoiLap; }
}
