...
public class LichSuNopTien {
    ...
    /** Helper field để lưu tên người thu (String) cho hiển thị. */
    private String nguoiThuName;

    /**
     * Lấy tên người thu (String) - helper method cho hiển thị.
     *
     * @return tên người thu
     */
    public String getNguoiThuName() {
        return nguoiThuName;
    }

    /**
     * Set tên người thu (String) - helper method cho hiển thị.
     *
     * @param nguoiThuName tên người thu
     */
    public void setNguoiThuName(String nguoiThuName) {
        this.nguoiThuName = nguoiThuName;
    }
}
