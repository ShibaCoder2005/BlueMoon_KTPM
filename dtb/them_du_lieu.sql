...
-- 2. BẢNG PHÒNG
INSERT INTO Phong (soPhong, dienTich, giaTien, trangThai) VALUES
('501', 50, 0, 'DangO'),  
('502', 50, 0, 'DangO'), 
('503', 50, 0, 'DangO'), 
('504', 50, 0, 'DangO'), 
...
('Tiền điện sinh hoạt', 'PhiDien', 0, 'VNĐ/hộ', 'Nhân khẩu', TRUE, 'Theo chỉ số đồng hồ'),
('Tiền nước sinh hoạt', 'PhiNuoc', 0, 'VNĐ/hộ', 'Nhân khẩu', TRUE, 'Theo chỉ số đồng hồ'),
('Quỹ vì người nghèo', 'TuNguyen', 0, 'VNĐ/hộ', 'Hộ khẩu', FALSE, 'Ủng hộ tự nguyện');

-- 7. BẢNG ĐỢT THU (3 đợt)
...
-- 8, 9. BẢNG PHIẾU THU & CHI TIẾT THU
